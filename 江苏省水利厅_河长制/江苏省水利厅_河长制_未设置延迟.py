...
class Handler(BaseHandler):
    ...
    def detail_page(self, response):
        ...
        selectors = [('#barrierfree_container > div.w1100.center > div.main-fl.bt-left > div:nth-child(6)', 'p', 'a>img'),
                     ('#zoom', 'p', 'img'),('#barrierfree_container > div.w1100.center > div.main-fl.bt-left > div:nth-child(6)','span','a>img')]
        text = ''
        ...
        if text.replace(' ','').replace('　','').replace('\n','').replace('\r','') == '':#如果text仍然为空
            text = '<p>'+response.doc('#barrierfree_container > div.w1100.center > div.main-fl.bt-left > div:nth-child(6)').text()+'</p>'
        come_from = ''
